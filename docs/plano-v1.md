...
| Edição básica da lista | [BE #1](https://github.com/lnrdgst/mercadeira/issues/1) → [FE #2](https://github.com/lnrdgst/mercadeira-frontend/issues/2), concluídas e aprovadas manualmente | Nome, categoria e estabelecimento editáveis somente em preparação, por criador ou administrador(a) ativo; capability exclusiva no frontend. Backend 315 testes; frontend 69 testes, build/lint aprovados. Validação manual integrada aprovada pelo usuário; checkpoint autorizado. |
