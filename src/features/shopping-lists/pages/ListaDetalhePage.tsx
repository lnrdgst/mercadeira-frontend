...
export function ListaDetalhePage() {
  ...
  return <section className="mx-auto max-w-3xl space-y-page py-page">
    ...
    {podeAlterar && itemParaRemover && <ConfirmarRemocaoItemDialog key={`${chave}:${itemParaRemover.id}`} descricao={itemParaRemover.descricao} focoAposRemocao={itensTituloRef} onConfirmar={removerItem} onCancelar={() => setItemParaRemover(null)} />}
