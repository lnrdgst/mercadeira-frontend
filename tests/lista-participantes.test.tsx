...
function preparar(participanteAtivo = true) {
  ...
  const fetchMock = vi.spyOn(globalThis, 'fetch').mockImplementation(async (input, options) => {
    ...
    if (path.endsWith('/listas/lista-a')) return Response.json({
      ...
      contextoUsuario: { membroFamiliaId: 'membro-c', papelFamilia: 'MEMBRO', participanteAtivo, podeGerenciarParticipantes: true, podeAlterarItens: false, podeEditarDadosBasicos: false },
    })
