...
function respostas(estado: EstadoRemoto) {
  return {
    lista: {
      ...
      contextoUsuario: { membroFamiliaId: 'membro-a', papelFamilia: 'MEMBRO', participanteAtivo: true, podeGerenciarParticipantes: false, podeAlterarItens: estado.podeAlterarItens ?? true, podeEditarDadosBasicos: true, podeSairDaLista: false, podeExcluirLista: false },
    },
